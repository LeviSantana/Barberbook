...
const OWNER_WHATSAPP = "71997028364"; // SEU número com DDI+DDD, sem espaços
        ...
        <div className="main">
          <div className="topbar">
            ...
            <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
              ...
              <div style={{ width: 36, height: 36, borderRadius: "50%", background: "var(--ink)", color: "var(--gold)", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Playfair Display,serif", fontWeight: 700, fontSize: 14 }}>A</div>
            </div>
          </div>
